...
public class EdgeUtilsTest {
    ...
    public void before() {
        ...
        edge = new TopologyEdge(new Edge(0, 0, 0, 0, n1, n2), v1, v2);
        edge_equal_1 = new TopologyEdge(new Edge(0, 0, 0, 0, n1, n2), v1, v2);
        edge_equal_2 = new TopologyEdge(new Edge(0, 0, 0, 0, n2, n1), v2, v1);
        edge_not_equal_1 = new TopologyEdge(new Edge(0, 0, 0, 0, n2, n3), v2, v3);
        edge_not_equal_2 = new TopologyEdge(new Edge(0, 0, 0, 0, n4, n3), v4, v3);
    }
