...
public class PingTest {
    ...
    public void testSinglePacketSimulation() throws NoSuchFieldException, IllegalAccessException {
        ...
        SimulationRuleBean rule = new SimulationRuleBean("", node1, node2, 1, 50, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.ICMP, true);
    ...
    public void testSinglePacket_3Nodes() throws NoSuchFieldException, IllegalAccessException {
        ...
        SimulationRuleBean rule = new SimulationRuleBean("", node1, node3, 1, 50, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.ICMP, true);
    ...
    public void testSinglePacketSimulation_infinitePing() throws NoSuchFieldException, IllegalAccessException {
        SimulationRuleBean rule = new SimulationRuleBean("", node1, node2, - 1, 50, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.ICMP, true);    //notice this -1
        rule.setRoute(Arrays.asList(node1, node2));
