...
public class PingTest {
    ...
    public void before() {
        ...
        edge1 = new Edge(100000000, node1, node2, 100, 0.0);
    ...
    public void testSinglePacketSimulation() throws NoSuchFieldException, IllegalAccessException {
        ...
        SimulationRuleBean rule = new SimulationRuleBean(node1, node2, 1, 50, true, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.UDP, true);
    ...
    public void testSinglePacket_3Nodes() throws NoSuchFieldException, IllegalAccessException {
        ...
        SimulationRuleBean rule = new SimulationRuleBean(node1, node3, 1, 50, true, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.UDP, true);
