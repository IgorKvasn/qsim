...
public class QueueingHelperTest {
    ...
    public void testCreateFragments() {
        ...
        NetworkNode node1 = new Router("node1", null, qosMechanism,null, 10, 10, 50, 10, 10, 100, 0, 0);
        NetworkNode node2 = new Router("node2", null, qosMechanism,null, 10, 10, 50, 10, 10, 100, 0, 0);
