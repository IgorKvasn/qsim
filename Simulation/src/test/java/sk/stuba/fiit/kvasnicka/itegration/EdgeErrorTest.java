...
public class EdgeErrorTest {
    ...
    public void before() {
        ...
        node1 = new Router("node1", qosMechanism, outputQueueManager1, 10, 10, 10, 10, 2.1, 0, 0);
        node2 = new Router("node2", qosMechanism, outputQueueManager2, 10, 10, 10, 10, 2.1, 0, 0);
    ...
    public void testSinglePacketSimulation_TCP() throws Exception {
        ...
        SimulationRuleBean rule = new SimulationRuleBean("", node1, node2, 1, 50, 0, PacketTypeEnum.AUDIO_PACKET, Layer4TypeEnum.TCP, IpPrecedence.IP_PRECEDENCE_0);
